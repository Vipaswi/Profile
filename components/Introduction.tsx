  ...
  return (
    <div className='flex flex-col md:flex-row mb-2 border border-gray-300 md:justify-evenly justify-center items-center bg-gradient-to-r from-slate-100 to-white border-s drop-shadow-md rounded-md'>
      ...
      <div className="pb-5 pr-5 pl-5 mb-10 items-center">
        <h2 className='text-6xl bold bg-gradient-to-r from-blue-500 via-purple-500 to-red-800 bg-clip-text text-transparent bold font-serif text-center md:text-start items-center'>Welcome!</h2>
          ...
          <div className='grid w-full xl:grid-cols-3 md:grid-cols-2 grid-cols-1 place-content-center'>
            {Proficiency.map(object => (
              <div className='flex m-1 justify-center md:justify-evenly items-center'>
                <p className='text-center mr-2 md:mr-0'>{object.Language}</p>
